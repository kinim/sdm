...
public class BatteryPointMapsActivity extends FragmentActivity {
    ...
    private void addMedicalPoints() {
        for (BatteryPoint batteryPoint : MarkerUtils.getBatteryPoints()) {
            mMap.addMarker(new MarkerOptions()
                    .position(batteryPoint.getLatLng())
                    .title(BatteryPoint.TITLE)
